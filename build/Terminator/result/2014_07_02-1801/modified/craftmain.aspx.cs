...
public partial class CraftMain : System.Web.UI.Page
{
    ...
    protected string tablename = "craft";
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["craft"] != null)
            craft = Request.QueryString["craft"];
        else
            craft = "";        
        ...
        screen = new AzzierScreen("codes/craftmain.aspx", "MainForm", MainControlsPanel.Controls, mode, 1);
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            if (craft != "")
            {
                ModuleoObject obj = new ModuleoObject(Session["Login"].ToString(), "craft", "craft", craft);
                nvc = obj.ModuleData;
            }

            screen.PopulateScreen("craft", nvc);
        }
    }
    ...
    protected void Save(object sender, EventArgs e)
    {
        ...
        if (CntlPanel != null)
        {
            nvc = screen.CollectFormValues("craft", false);
        ...
        if (craft == "")
        {
            obj = new ModuleoObject(Session["Login"].ToString(), "craft", "craft");
            success = obj.Create(nvc);
        }
        else
        {
            obj = new ModuleoObject(Session["Login"].ToString(), "craft", "craft", craft);
