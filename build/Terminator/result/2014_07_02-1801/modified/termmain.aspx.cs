...
public partial class TermMain : System.Web.UI.Page
{
  ...
  protected void Page_Init(object sender, EventArgs e)
  {
    ...
    if (Request.QueryString["termcode"] != null)
      termcode = Request.QueryString["termcode"];
    else
      termcode = "";
    ...
    screen = new AzzierScreen("codes/termmain.aspx", "MainForm", MainControlsPanel.Controls, mode, 1);
  ...
  protected void Page_Load(object sender, EventArgs e)
  {
    if (!Page.IsPostBack)
    {
      ...
      if (termcode != "")
      {
        ModuleoObject obj = new ModuleoObject(Session["Login"].ToString(), "terms", "code", termcode);
        nvc = obj.ModuleData;
      }

      screen.PopulateScreen("terms", nvc);
    }
  }
  ...
  protected void Save(object sender, EventArgs e)
  {
    ...
    if (CntlPanel != null)
    {
      nvc = screen.CollectFormValues("terms", false);
    ...
    if (termcode == "")
    {
      obj = new Terms(Session["Login"].ToString(), "terms", "code");
      success = obj.Create(nvc);
    }
    else
    {
      obj = new Terms(Session["Login"].ToString(), "terms", "code", termcode);
  ...
  {
    bool success = false;
    Terms obj = new Terms(Session["Login"].ToString(), "terms", "code", termcode);
  ...
  {
    SystemMessage msg = new SystemMessage("codes/termmain.aspx");
