...
public partial class inventory_whereused : System.Web.UI.Page
{
    AzzierScreen screen;
    ...
    {
        screen = new AzzierScreen("inventory/whereused.aspx", "MainForm", MainControlsPanel.Controls);
    ...
    private void InitGrid()
    {
      ...
      string wherestring = v.AddLinqConditions("partitemnum^" + m_itemnum, "inventory/whereused.aspx", "eqplist", "v_CompEquipmentList", null, null, "query");

      grdeqplist.ClientSettings.DataBinding.SelectMethod = "GetWhereUsed?wherestring=" + wherestring;
      grdeqplist.ClientSettings.DataBinding.Location = "../InternalServices/ServiceInventory.svc";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ucHeader1.Mode = "edit";
        ucHeader1.TabName = "Where Used";
        ucHeader1.ModuleData = nvcitems;
        ucHeader1.OperationLabel = "Where Used";
    }
